...
define('dosa',['jquery', 'hammer', 'browser'], function ($, Hammer, Browser)
    {
        var Dosa = function () {
...
define('carousel',['jquery', 'swiper', 'browser'], function ($, Swiper, Browser)
    {
...
define('iphoneViewportFixer',[], function() {
...
define('twitter',['jquery'], function ($)
    {
...
define('simplecors',['jquery'], function($) {
    var CORS = {
        ajax: function(args) {
            var
...
define('blog',['simplecors', 'jquery'], function (Simplecors, $)
    {
        var Blog = function () {
            this.initialize = function () {
                var ins = this;
...
define('mobilemenu',['jquery', 'hammer', 'browser', 'underscore'], function ($, Hammer, Browser, _)
    {
        var MobileMenu = {
            initialize: function () {
                var ins = this;
...
define('disallowHover',['jquery'], function ($) {
    var DisallowHover = {
        initialize: function() {
            var $html = $(document.documentElement);
...
define('carouselImages',['jquery'], function ($) {
...
define('components/basicImage',['jquery', 'browser'], function ($, Browser)
	{
		var BasicImage = {
			initialize: function () {
...
define('components/map',['leaflet', 'underscore'], function (L, _) {
...
define('insertAudioTagsFromLinks',['jquery'], function ($) {
    return {
...
define('components/quickExit',['jquery'], function ($) {
